                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            <h2 class="text-x1 font-semibold text-black">Aplicacion de condominios</h2>
                        </div>
                        @if (Route::has('login'))
                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                    <img
                                        src="https://img.resemmedia."
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        <div class="pt-10 sm:pt-5 lg:pt-0">
                                            <h2 class="text-xl font-semibold text-black">Clusters</h2>

                                            <p class="mt-8 text-sm/relaxed">
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Guardias</h2>
                                </div>
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Casas</h2>
                                </div>
                            ...
                            <a>
                                <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10">
                                    ...
                                    <div class="pt-4 sm:pt-5">
                                        <h2 class="text-xl font-semibold text-black">Amenidades</h2>
                            ...
                            <a>
                                <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10">
                                    ...
                                    <div class="pt-4 sm:pt-5">
                                        <h2 class="text-xl font-semibold text-black">Casetas</h2>
                            ...
                            <a>
                                <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10">
                                    ...
                                    <div class="pt-4 sm:pt-5">
                                        <h2 class="text-xl font-semibold text-black">Entradas</h2>
